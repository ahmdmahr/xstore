                    ...
                    <div class="card-body">
                        ...
                        <div class="row checkout-form">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control"  value="{{Auth::user()->fname}}" name="fname" placeholder="Enter First Name"> </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="text" class="form-control"  value="{{Auth::user()->address1}}" name="address1" placeholder="Enter Address 1"> </div>
                            <div class="col-md-6 mt-3">
